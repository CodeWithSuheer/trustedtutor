    ...
    return (
        <>
            <div className="w-full text-center bg-surfacev2 text-black rounded-xl shadow-xl">
                ...
                <div className="box px-2 bg-lightSurface text-dark font-semibold py-4 rounded-t-xl text-md sm:text-lg tracking-wide">15% Off! 🌟 on Your First Assignment</div>

                <div className="content px-3 sm:px-6 mt-6 pb-6">
                    <h2 className="mb-4 text-black text-2xl font-semibold">Need Professional Help with Your Assignments?<span className="text-primaryText"> Chat Now</span></h2>

                    <p className="mb-4 text-sm sm:text-md max-w-sm mx-auto">Reach out to our experts today and aim for top grades without the added tension!</p>
...
export default EmailFormForAssignment