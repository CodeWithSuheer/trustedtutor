...
const EmailFormForHelpWithCourses = () => {
    ...
    return (
        <>
            <div className="w-full text-center bg-surfacev2 text-black rounded-xl shadow-xl">
                ...
                <div className="box px-2 bg-lightSurface text-dark font-semibold py-4 rounded-t-xl text-md sm:text-lg tracking-wide">15% Off! 🌟 on Your First Online Course</div>

                <div className="content px-3 sm:px-6 mt-6 pb-6">
                    <h2 className="mb-4 text-black text-2xl font-semibold">Need Expert Help for Your Online Course?<span className="text-primaryText"> Chat Now</span></h2>

                    <p className="mb-4 text-sm sm:text-md max-w-md mx-auto">Avoid unnecessary stress—let our experts handle your coursework while you focus on mastering the material!</p>

                    <p className="mb-4 font-medium text-sm sm:text-md">24/7 Support & Trusted Course Assistance</p>
                    ...
                    <div className="buttons flex justify-center items-center flex-wrap gap-2">
                        ...
                        <a
                            href="mailto:support@trustedclasshelper@gmail.com"
                            target="_blank"
...
export default EmailFormForHelpWithCourses
