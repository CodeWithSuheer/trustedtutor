    ...
    <>
      <section className="">
        <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
          ...
          <div className="mt-12 [column-fill:_balance] sm:columns-2 sm:gap-6 lg:columns-3 lg:gap-8">
            <div className="mb-8 sm:break-inside-avoid" data-aos="fade-up">
              <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-lg font-medium">Sarah Nicholas</p>
                    <p className="text-xs font-medium text-gray-800">Order Id # 9283</p>
                  </div>
                </div>

                <p className="mt-4">
                  “I was worried about staying on top of my online class, but the support from Trusted Class Helper  changed everything. I not only managed to earn an A but also gained a deeper grasp of the course material.”
                </p>
              </blockquote>
            </div>
              ...
              <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-medium text-gray-800">Order Id # 5245</p>
                  </div>
                </div>

                <p className="mt-4 text-gray-700">
                  “Exams have always made me nervous, but the strategies and practice sessions I got from Trusted Class Helper  boosted my confidence and results more than I ever expected.”
                </p>
              </blockquote>
            </div>
              ...
              <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-medium text-gray-800">Order Id # 3512</p>
                  </div>
                </div>

                <p className="mt-4 text-gray-700">
                  “Assignments used to overwhelm me. Thanks to Trusted Class Helper , I’m meeting deadlines effortlessly, and my grades are already going up.”
                </p>
              </blockquote>
            </div>
              ...
              <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-medium text-gray-800">Order Id # 6399</p>
                  </div>
                </div>

                <p className="mt-4 text-gray-700">
                  “I’ve tried other services before, but none compare to Trusted Class Helper in terms of quality and reliability. I’ll definitely be back for future help!”
              ...
              <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-medium text-gray-800">Order Id # 2351</p>
                  </div>
                </div>

                <p className="mt-4 text-gray-700">
                  “Balancing work, family, and classes isn’t easy, but the tutors at Trusted Class Helper have been flexible and supportive every step of the way. They’re a true lifesaver!”
                </p>
              </blockquote>
            </div>
              ...
              <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-medium text-gray-800">Order Id # 5111</p>
                  </div>
                </div>

                <p className="mt-4 text-gray-700">
                  “Late-night questions, last-minute study sessions—Trusted Class Helper  has been there for it all. Knowing I can get help anytime truly puts me at ease.”
                </p>
              </blockquote>
            </div>
              ...
              <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-medium text-gray-800">Order Id # 7493</p>
                  </div>
                </div>
              ...
              <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-medium text-gray-800">Order Id # 8995</p>
                  </div>
                </div>

                <p className="mt-4 text-gray-700">
                  “As a non-native English speaker, I’ve always found writing challenging. Trusted Class Helper’s support helped me meet my professors’ standards and build my confidence.”
                </p>
              </blockquote>
            </div>
              ...
              <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-medium text-gray-800">Order Id # 6257</p>
                  </div>
                </div>

                <p className="mt-4 text-gray-700">
                  “When I had a research paper due in no time, Trusted Class Helper  came through with top-quality work. I met my deadline and ended up with an excellent grade!”
                </p>
              </blockquote>
            </div>
          </div>
