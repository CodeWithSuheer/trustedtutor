            ...
            <section className="home_team w-full">
                <div className="max-w-7xl mx-auto py-16 px-4 sm:px-0">
                    ...
                    <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
                        {/* Stat box 1 */}
                        <div className="bg-white/90 bg-opacity-90 rounded-lg px-4 py-4 border-2 border-white flex flex-col items-center justify-center">
                            <div className="flex items-center">
                                <span className="text-4xl font-bold text-gray-800">99.9%</span>
                                <FaSmile className="ml-2 text-2xl text-amber-500" />
                            </div>
                            <p className="text-sm font-medium mt-2 text-gray-700">Student Satisfaction</p>
                        </div>

                        {/* Stat box 2 */}
                        <div className="bg-white/90 bg-opacity-90 rounded-lg px-4 py-4 border-2 border-white flex flex-col items-center justify-center">
                            <div className="flex items-center">
                                <span className="text-4xl font-bold text-gray-800">5000</span>
                                <FaUserGraduate className="ml-2 text-2xl text-amber-500" />
                            </div>
                            <p className="text-sm font-medium mt-2 text-gray-700">Students</p>
                        </div>
                        ...
                        <div className="bg-white/90 bg-opacity-90 rounded-lg px-4 py-4 border-2 border-white flex flex-col items-center justify-center">
                            ...
                            <p className="text-sm font-medium mt-2 text-gray-700">Years Of Expertise</p>
                        </div>
                        ...
                        <div className="bg-white/90 bg-opacity-90 rounded-lg px-4 py-4 border-2 border-white flex flex-col items-center justify-center">
                            ...
                            <p className="text-sm font-medium mt-2 text-gray-700">PHDs Experts</p>
                        </div>
                    </div>
